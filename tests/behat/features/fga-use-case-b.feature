Feature: Use case B: Institutions sharing vetting locations
  ...
  Scenario: Scenario: Setup of the institution configuration and test users
     Given I have the payload
      ...
      And the user "urn:collab:person:institution-a.example.com:joe-a-ra" has the role "ra"
      ...
      And the user "urn:collab:person:institution-d.example.com:joe-d-ra" has the role "ra"
